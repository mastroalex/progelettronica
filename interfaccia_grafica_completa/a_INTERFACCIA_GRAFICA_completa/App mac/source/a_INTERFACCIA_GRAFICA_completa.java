...
public class a_INTERFACCIA_GRAFICA_completa extends PApplet {
...
public class Termom {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--stop-color=#cccccc", "a_INTERFACCIA_GRAFICA_completa" };
    if (passedArgs != null) {
